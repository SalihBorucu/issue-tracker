        ...
        babelHelpers.createClass(DragulaService, [{
            ...
            },
            {
                ...
                value: function handleModels(name, drake) {
                    ...
                    drake.on("remove", function(el, container, source) {
                        ...
                        sourceModel = _this2.findModelForContainer(
                            source,
                            drake
                        );
                        sourceModel.splice(dragIndex, 1);
                        drake.cancel(true);
                        _this2.eventBus.$emit("removeModel", [
                            name,
                            el,
                            source,
                            dragIndex
                    ...
                    drake.on("drop", function(dropElm, target, source) {
                        ...
                        if (target === source) {
                            ...
                            var targetModel = _this2.findModelForContainer(
                                target,
                                drake
                            );
                        ...
                        _this2.eventBus.$emit("dropModel", [
                            name,
                            dropElm,
                            target,
                            source,
            ...
            },
            {
                ...
                value: function findModelForContainer(container, drake) {
                    return (
                        this.findModelContainerByContainer(container, drake) || {}
                    ).model;
                }
            },
            {
                key: "findModelContainerByContainer",
                value: function findModelContainerByContainer(
                    container,
                    drake
                ) {
                    if (!drake.models) {
